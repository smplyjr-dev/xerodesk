...
<head>
  ...
  <title>XMCIT | Email Verification</title>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="left" bgcolor="#ffffff"
              ...
              <h1
                style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px; color: #4d4d4d;">
                Hi {{ $user->bio->first_name }},</h1>
            </td>
          </tr>
        </table>
        <!--[if (gte mso 9)|(IE)]>
    ...
    <tr>
      <td align="center" bgcolor="#e9ecef">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="margin:0 15px;" width="100%">
                      <tr>
                        <td align="center" style=" padding:20px 20px 40px 20px;">
                          <a href="{{ $url }}" style="font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; color: #ffffff; background-color: #99bd3c; padding: 16px 32px; border: 2px solid #99bd3c; border-radius: 5px; text-decoration: none;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">See you inside!</p>
            </td>
          </tr>
